import {
  ...
  useSlotProps,
  useTheme
<<<<<<<< HEAD:node_modules/.vite/deps/chunk-AB25K3EK.js
} from "./chunk-YKV2DXJZ.js";
========
} from "./chunk-RKUYYB2X.js";
>>>>>>>> a3312d6b6ddaeac5fb05a27a1724db16a7a5a49e:node_modules/.vite/deps/chunk-GGG3HXYF.js
import {
  capitalize_default,
  chainPropTypes,
  clsx_default,
...
var ListItemSecondaryAction = React6.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(ListItemSecondaryActionRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ListItem = React7.forwardRef(function ListItem2(inProps, ref) {
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime6.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime7.jsxs)(ListItemContainer, _extends({
        as: ContainerComponent,
        className: clsx_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [(0, import_jsx_runtime6.jsx)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
          as: Component,
...
var _excluded7 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React8.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime8.jsxs)(React8.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime8.jsxs)(React8.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var _excluded8 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var TabScrollButton = React9.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime9.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime9.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
function ScrollbarSize(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("div", _extends({
    style: styles,
    ref: nodeRef
  }, other));
}
...
var Tabs = React11.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime11.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime11.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime11.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime12.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime12.jsxs)(TabsScroller, {
...
<<<<<<<< HEAD:node_modules/.vite/deps/chunk-AB25K3EK.js
//# sourceMappingURL=chunk-AB25K3EK.js.map
========
//# sourceMappingURL=chunk-GGG3HXYF.js.map
>>>>>>>> a3312d6b6ddaeac5fb05a27a1724db16a7a5a49e:node_modules/.vite/deps/chunk-GGG3HXYF.js
