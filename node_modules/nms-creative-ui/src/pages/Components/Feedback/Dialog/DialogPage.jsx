...
import COMPONENTS from "../../Feedback/Dialog/data/components";
    ...
    <Stack spacing={6}>
      <Box>
        <Stack direction={"column"} spacing={3}>
          ...
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/material-ui/react-dialog/" target="_blank">
              <Typography>https://mui.com/material-ui/react-dialog/</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
