    ...
    <CustPaper>
      <TabContext value={value}>
        ...
        <TabPanel value={item.first_value}>
          <DashedPaper>{React.createElement(item.component)}</DashedPaper>
        </TabPanel>
    ...
    <Stack spacing={6}>
        ...
        <Stack direction={"column"} spacing={3}>
          ...
          <Stack direction={"column"} spacing={1}>
            ...
            <Typography variant="body1">
              The container centers your content horizontally. It's the most
              basic layout element.
            </Typography>
          </Stack>
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/components/menu" target="_blank">
              <Typography>https://mui.com/components/menu</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
      <Stack direction="column" spacing={6}>
        {COMPONENTS.map((item, index) => (
          <ContainerTab key={index} item={item} />
        ))}
      </Stack>
    </Stack>
  );
