    ...
    <Stack spacing={6}>
      <Box>
        <Stack direction={"column"} spacing={3}>
          <Stack direction={"row"} spacing={1}>
            <Icon
              solariconset={SolarIconSet.Plain2}
              size={24}
          ...
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/components/pagination" target="_blank">
              <Typography>https://mui.com/components/pagination</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
      <Stack direction="column" spacing={6}>
        {COMPONENTS.map((item, index) => (
          <PaginationTab key={index} item={item} />
        ))}
      </Stack>
    </Stack>
  );
