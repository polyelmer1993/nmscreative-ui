    ...
    <Stack spacing={6}>
      <Box>
        <Stack direction={"column"} spacing={3}>
          ...
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/components/tabs" target="_blank">
              <Typography>https://mui.com/components/tabs</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
      <Stack direction="column" spacing={6}>
        {COMPONENTS.map((item, index) => (
          <TabpageTab key={index} item={item} />
        ))}
      </Stack>
    </Stack>
  );
