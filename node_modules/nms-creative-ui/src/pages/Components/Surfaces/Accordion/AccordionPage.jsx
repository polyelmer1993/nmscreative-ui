    ...
    <Stack spacing={6}>
      <Box>
        <Stack direction={"column"} spacing={3}>
          <Stack direction={"row"} spacing={1}>
            <Icon
              solariconset={SolarIconSet.MaximizeSquare}
              size={24}
              iconStyle={"BoldDuotone"}
              color={"secondary"}
            />

            <Typography variant="body1">Surfaces</Typography>
          </Stack>
          ...
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/components/accordion" target="_blank">
              <Typography>https://mui.com/components/accordion</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
      <Stack direction="column" spacing={2}>
        {COMPONENTS.map((item, index) => (
          <AccordionTab key={index} item={item} />
        ))}
      </Stack>
    </Stack>
  );
