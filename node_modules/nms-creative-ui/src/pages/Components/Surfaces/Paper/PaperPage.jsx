        ...
        <Stack direction={"column"} spacing={3}>
          <Stack direction={"row"} spacing={1}>
            <Icon color={"secondary"}>
              <SolarIconSet.MaximizeSquare size={24} iconStyle="BoldDuotone" />
            </Icon>
          ...
          <Stack direction={"column"} spacing={1}>
            <a href="https://mui.com/material-ui/react-paper/" target="_blank">
              <Typography>https://mui.com/material-ui/react-paper/</Typography>
            </a>
          </Stack>
        </Stack>
      </Box>
