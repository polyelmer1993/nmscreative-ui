...
var Rocket2 = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React.createElement("g", { opacity: 0.5, fill: "currentColor" },
            React.createElement("path", { d: "M10.846 5.41 8.658 7.59c-.402.401-.77.769-1.062 1.101a5.231 5.231 0 0 0-.532.706l-.022-.021-.08-.08a4.178 4.178 0 0 0-1.319-.865l-.106-.042-.325-.13a.658.658 0 0 1-.223-1.077c.963-.96 2.12-2.114 2.679-2.346a2.907 2.907 0 0 1 1.537-.197c.47.07.915.311 1.641.77ZM14.582 16.893c.176.18.293.306.399.44.14.179.264.368.373.567.123.223.218.462.408.939.155.388.67.491.968.193l.073-.072c.963-.96 2.12-2.114 2.353-2.67.204-.492.273-1.022.197-1.534-.07-.468-.312-.912-.772-1.636l-2.195 2.189c-.411.41-.789.786-1.13 1.08a5.179 5.179 0 0 1-.674.504Z" })),
        React.createElement("g", { opacity: 0.5, fill: "currentColor" },
            React.createElement("path", { d: "M7.686 14.563a.759.759 0 1 0-1.073-1.073L4.47 15.632a.759.759 0 1 0 1.074 1.074l2.142-2.143ZM10.495 17.369a.759.759 0 1 0-1.073-1.073l-2.128 2.127a.76.76 0 0 0 1.074 1.074l2.127-2.128Z" }))) }; return React.createElement(IconWrapper_1.IconWrapper, __assign({ icon: styles[iconStyle || 'Linear'] }, restProps)); };
exports["default"] = Rocket2;
