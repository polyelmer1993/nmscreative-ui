...
var OutgoingCall = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React.createElement("path", { d: "M16 4.25a.75.75 0 0 0 0 1.5h1.19l-2.72 2.72a.75.75 0 1 0 1.06 1.06l2.72-2.72V8a.75.75 0 0 0 1.5 0V5a.75.75 0 0 0-.75-.75h-3Z", fill: "currentColor" })), Bold: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M14.47 8.47a.75.75 0 0 0 1.06 1.06l-1.06-1.06ZM19 5h.75a.75.75 0 0 0-.75-.75V5Zm-.75 3a.75.75 0 0 0 1.5 0h-1.5ZM16 4.25a.75.75 0 0 0 0 1.5v-1.5Zm-.47 5.28 4-4-1.06-1.06-4 4 1.06 1.06ZM18.25 5v3h1.5V5h-1.5Zm.75-.75h-3v1.5h3v-1.5ZM15.556 14.548l-.455.48s-1.083 1.139-4.038-1.972c-2.955-3.111-1.872-4.25-1.872-4.25l.287-.303c.706-.744.773-1.938.156-2.81L8.374 3.91C7.61 2.83 6.135 2.688 5.26 3.609L3.691 5.26c-.433.457-.723 1.048-.688 1.705.09 1.68.808 5.293 4.812 9.51 4.247 4.47 8.232 4.648 9.861 4.487.516-.05.964-.329 1.325-.709l1.42-1.496c.96-1.01.69-2.74-.538-3.446l-1.91-1.1c-.806-.463-1.787-.327-2.417.336Z", fill: "currentColor" })), BoldDuotone: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M14.47 8.47a.75.75 0 0 0 1.06 1.06l-1.06-1.06ZM19 5h.75a.75.75 0 0 0-.75-.75V5Zm-.75 3a.75.75 0 0 0 1.5 0h-1.5ZM16 4.25a.75.75 0 0 0 0 1.5v-1.5Zm-.47 5.28 4-4-1.06-1.06-4 4 1.06 1.06ZM18.25 5v3h1.5V5h-1.5Zm.75-.75h-3v1.5h3v-1.5Z", fill: "currentColor" }),
