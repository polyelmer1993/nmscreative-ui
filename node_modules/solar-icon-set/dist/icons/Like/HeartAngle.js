...
var HeartAngle = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React.createElement("path", { d: "M8.106 18.247C5.298 16.083 2 13.542 2 9.137 2 4.274 7.5.825 12 5.501l2 1.998a.75.75 0 0 0 1.06-1.06L13.13 4.506C17.369 1.403 22 4.675 22 9.137c0 4.405-3.298 6.946-6.106 9.11-.292.225-.579.445-.856.664C14 19.729 13 20.5 12 20.5s-2-.77-3.038-1.59c-.277-.218-.564-.438-.856-.663Z", fill: "currentColor" })), BoldDuotone: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { opacity: 0.5, fillRule: "evenodd", clipRule: "evenodd", d: "M2 9.137c0 4.405 3.298 6.946 6.106 9.11.292.225.579.445.856.664C10 19.729 11 20.5 12 20.5v-15C7.5.826 2 4.275 2 9.138Z", fill: "currentColor" }),
        React.createElement("path", { d: "m14 7.5-2-2v15c1 0 2-.77 3.038-1.59.277-.218.564-.438.856-.663C18.702 16.083 22 13.542 22 9.137c0-4.462-4.631-7.734-8.871-4.63l1.931 1.931A.75.75 0 0 1 14 7.5Z", fill: "currentColor" })) }; return React.createElement(IconWrapper_1.IconWrapper, __assign({ icon: styles[iconStyle || 'Linear'] }, restProps)); };
exports["default"] = HeartAngle;
