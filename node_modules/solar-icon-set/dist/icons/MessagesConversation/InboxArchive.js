...
var InboxArchive = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M4 15h2.301c.809 0 1.213 0 1.576.148.033.013.065.027.098.043.354.167.628.464 1.175 1.059l.035.038c.513.557.769.835 1.096 1 .061.03.124.058.188.082.343.13.72.13 1.477.13.715 0 1.073 0 1.4-.117.061-.022.121-.047.18-.075.314-.148.567-.401 1.073-.907l.23-.23c.577-.577.866-.866 1.234-1.019.368-.152.776-.152 1.594-.152H20M5 15v-1.5A1.5 1.5 0 0 1 6.5 12h8.25m2.75 0a1.5 1.5 0 0 1 1.5 1.5V15", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round" }),
        React.createElement("path", { d: "M5 14v-3.5A1.5 1.5 0 0 1 6.5 9H10m9 5v-3.5A1.5 1.5 0 0 0 17.5 9H14", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round" }),
        React.createElement("path", { d: "M5 11V7.5A1.5 1.5 0 0 1 6.5 6M19 11V7.5A1.5 1.5 0 0 0 17.5 6H9.25", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round" }),
        ...
        React.createElement("path", { opacity: 0.5, d: "M3.464 20.535C4.93 22 7.286 22 12 22c4.714 0 7.071 0 8.535-1.465C22 19.072 22 16.714 22 12s0-7.071-1.465-8.536C19.072 2 16.714 2 12 2S4.929 2 3.464 3.464C2 4.93 2 7.286 2 12c0 4.714 0 7.071 1.464 8.535Z", fill: "currentColor" }),
        React.createElement("path", { d: "M5 8.5v-1A1.5 1.5 0 0 1 6.5 6h11A1.5 1.5 0 0 1 19 7.5v1a2.489 2.489 0 0 0-1.5-.5h-11c-.563 0-1.082.186-1.5.5ZM5 11.5v-1A1.5 1.5 0 0 1 6.5 9h11a1.5 1.5 0 0 1 1.5 1.5v1a2.49 2.49 0 0 0-1.5-.5h-11a2.49 2.49 0 0 0-1.5.5ZM20.75 15a.75.75 0 0 0-.75-.75h-1.02v-1A1.5 1.5 0 0 0 17.5 12h-11a1.5 1.5 0 0 0-1.48 1.25v1H4a.75.75 0 0 0 0 1.5h2.301c.87 0 1.098.013 1.293.092l.061.027c.19.09.355.25.943.889l.036.038.075.083c.438.476.783.852 1.236 1.08.084.041.17.08.258.113.474.18.985.179 1.631.178h.218c.611 0 1.094.001 1.547-.161.084-.03.167-.064.248-.103.434-.205.775-.547 1.207-.98l.075-.074.23-.23c.621-.621.793-.775.991-.857.198-.082.428-.095 1.307-.095H20a.75.75 0 0 0 .75-.75Z", fill: "currentColor" })) }; return React.createElement(IconWrapper_1.IconWrapper, __assign({ icon: styles[iconStyle || 'Linear'] }, restProps)); };
exports["default"] = InboxArchive;
