...
var InboxOut = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M11.25 10a.75.75 0 0 0 1.5 0h-1.5ZM12 2l.53-.53a.75.75 0 0 0-1.06 0L12 2Zm2.47 3.53a.75.75 0 1 0 1.06-1.06l-1.06 1.06Zm-6-1.06a.75.75 0 0 0 1.06 1.06L8.47 4.47ZM12.75 10V2h-1.5v8h1.5Zm-1.28-7.47 3 3 1.06-1.06-3-3-1.06 1.06Zm0-1.06-3 3 1.06 1.06 3-3-1.06-1.06Z", fill: "currentColor" }),
        React.createElement("path", { d: "M2 13h3.16c.905 0 1.358 0 1.756.183.398.183.692.527 1.281 1.214l.606.706c.589.687.883 1.031 1.281 1.214.398.183.85.183 1.756.183h.32c.905 0 1.358 0 1.756-.183.398-.183.692-.527 1.281-1.214l.606-.706c.589-.687.883-1.031 1.281-1.214.398-.183.85-.183 1.756-.183H22", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round" }),
