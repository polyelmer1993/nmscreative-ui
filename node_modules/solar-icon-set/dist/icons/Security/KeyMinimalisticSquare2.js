...
var KeyMinimalisticSquare2 = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React.createElement("path", { opacity: 0.5, d: "M15.518 8.482a.917.917 0 0 1 0-1.297l-1.06-1.06a2.417 2.417 0 0 0 0 3.418l1.06-1.061Zm1.297 0a.917.917 0 0 1-1.297 0l-1.06 1.06a2.417 2.417 0 0 0 3.417 0l-1.06-1.06Zm0-1.297a.917.917 0 0 1 0 1.297l1.06 1.06a2.417 2.417 0 0 0 0-3.417l-1.06 1.06Zm1.06-1.06a2.417 2.417 0 0 0-3.417 0l1.06 1.06a.917.917 0 0 1 1.297 0l1.06-1.06Z", fill: "currentColor" }),
