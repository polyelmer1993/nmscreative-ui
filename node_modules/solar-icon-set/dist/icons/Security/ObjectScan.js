...
var ObjectScan = function (allProps) { var props = allProps.svgProps, iconStyle = allProps.iconStyle, restProps = __rest(allProps, ["svgProps", "iconStyle"]); var styles = { Broken: React.createElement("svg", __assign({ width: "inherit", height: "inherit", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        ...
        React.createElement("path", { opacity: 0.5, d: "M10 5.5h4c1.886 0 2.828 0 3.414.586.55.55.584 1.414.586 3.078V14.5c0 1.886 0 2.828-.586 3.414-.586.586-1.528.586-3.414.586h-4c-1.886 0-2.828 0-3.414-.586C6 17.328 6 16.386 6 14.5V9.164c.002-1.664.036-2.528.586-3.078C7.172 5.5 8.114 5.5 10 5.5Z", fill: "currentColor" }),
        React.createElement("path", { d: "M18.37 9.3c-.119-.045-.242-.09-.37-.136-1.833-.778-6.8-1.868-12 0-.128.045-.251.09-.37.136a10.02 10.02 0 0 0-1.553.744 6.021 6.021 0 0 0-.54.365l-.01.009-.004.003-.002.002H3.52a.75.75 0 0 0 .957 1.156l.01-.008.063-.047c.06-.043.16-.11.298-.193A8.517 8.517 0 0 1 6.17 10.7c1.214-.467 3.123-.95 5.831-.95 2.709 0 4.617.483 5.83.95a8.514 8.514 0 0 1 1.322.63 4.46 4.46 0 0 1 .36.24l.011.009a.75.75 0 0 0 .957-1.155L20 11c.48-.576.479-.577.479-.577l-.002-.002-.004-.003-.01-.009a2.6 2.6 0 0 0-.141-.105 6.032 6.032 0 0 0-.399-.26A10.02 10.02 0 0 0 18.37 9.3Z", fill: "currentColor" })) }; return React.createElement(IconWrapper_1.IconWrapper, __assign({ icon: styles[iconStyle || 'Linear'] }, restProps)); };
exports["default"] = ObjectScan;
